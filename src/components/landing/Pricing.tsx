...
export function Pricing() {
  return (
    <section id="precios" className="max-w-[1400px] mx-auto px-6 pb-32">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-medium text-slate-900 tracking-tight mb-4">Precios transparentes</h2>
