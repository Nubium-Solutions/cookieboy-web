...
export function Pillars() {
  return (
    <section className="max-w-[1400px] mx-auto py-20 md:py-32 px-4 sm:px-6">
      <div className="text-center mb-14 md:mb-24">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-slate-900 tracking-tight mb-6 leading-tight">
          Por qué elegir CookieBoy
        </h2>
        <p className="text-base md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed font-light">
          Tres razones por las que agencias y consultores LOPD ya están migrando
          desde Cookiebot y CookieYes.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 md:min-h-[600px]">
        {pillars.map((p) => (
          <div
            key={p.title}
            className="glass-panel rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-8 md:p-10 flex flex-col justify-between group hover:-translate-y-2 transition-all duration-700 shadow-sm hover:shadow-md"
          >
            <div>
